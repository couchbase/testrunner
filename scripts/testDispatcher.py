...
def get_servers_cloud(options, descriptor, how_many, is_addl_pool, os_version, pool_id):
    ...
    if options.serverType == AWS:
        ...
        return cloud_provision.az_get_servers(descriptor, how_many, os_version, type, ssh_public_key_path, ssh_private_key_path)
        ...
        try:
            ...
            if haveTestToLaunch:
                ...
                if testsToLaunch[i]['framework'] == "TAF":
                    slave_to_use = "deb12_jython_slave" if slave_to_use == "P0" else slave_to_use
