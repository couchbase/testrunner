...
def post_provisioner(host, username, ssh_key_path, modify_hosts=False):
        ...
        is_modern_distro = is_rhel9_or_newer or is_debian13_or_newer or is_rocky10_or_newer

        log.info(f"DEBUG: Modern distribution detected: {is_modern_distro} (RHEL9+: {is_rhel9_or_newer}, Debian13+: {is_debian13_or_newer}, Rocky10+: {is_rocky10_or_newer})")
