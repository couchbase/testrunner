...
def az_get_servers(name, count, os, type, ssh_public_key_path, ssh_private_key_path):
    ...
    subscription_id = OS.environ["BACKUP_RESTORE_AZURE_SUBSCRIPTION_KEY"]
    ...
    credential = ClientSecretCredential(
        tenant_id=OS.environ["BACKUP_RESTORE_AZURE_TENANT_ID"],
        client_id=OS.environ["BACKUP_RESTORE_AZURE_CLIENT_ID"],
        client_secret=OS.environ["BACKUP_RESTORE_AZURE_CLIENT_SECRET"]
    )
