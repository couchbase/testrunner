...
ALMA = ["alma9"]
LINUX_DISTROS = AMAZON + CENTOS + DEBIAN + OEL + RHEL + SUSE + UBUNTU + ALMA
...
X86 = CENTOS + SUSE + RHEL + OEL + AMAZON + ALMA
LINUX_AMD64 = DEBIAN + UBUNTU
AMD64 = DEBIAN + UBUNTU + WINDOWS_SERVER
DEBUG_INFO_SUPPORTED = CENTOS + SUSE + RHEL + OEL + AMAZON + DEBIAN + UBUNTU + ALMA
