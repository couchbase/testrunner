...
class basic_collections(BaseTestCase):
    ...
    def test_valid_scope_name(self):
        ...
        valid_scope_names = ["MYSCPOE", "MY_SCOPE", "MY-Scope_27%", "Scope_With-Largename_81%Scope%", "8", "A", "a",
                            "aaa9999%"]
    ...
    def test_valid_collection_name(self):
        ...
        valid_collection_names = ["MYCOLLECTION", "MY_COLLECTION", "MY-Collection_27%", "CollectionsWithLargeNamechecki",
    ...
    def test_invalid_collection_name(self):
        ...
        invalid_collection_names = ["$collection", "%collection", "_mycollection", "{collection", "s{[]/,.",
