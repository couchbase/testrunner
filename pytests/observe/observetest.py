...
class ObserveTests( BaseTestCase ):
    ...
    def test_observe_basic_data_load_delete( self ):
        ...
        self.node_servers = rest.get_nodes()
        self._wait_for_stats_all_buckets( self.node_servers )
        ...
        self.cluster.query_view( self.master, "dev_Doc1", self.default_view.name, query, self.num_items, self.default_bucket_name )
