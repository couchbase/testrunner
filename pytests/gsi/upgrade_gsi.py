        ...
        with ThreadPoolExecutor() as executor_main:
            try:
                ...
                if self.continuous_mutations:
                    ...
                    scan_results_check = False
                l1 = [
                    f"CREATE INDEX `hotel88983c146f0e4c55a9734e20cb7d3b44price` ON default:{self.test_bucket}.test_scope_1.test_collection_1(price) USING GSI  WITH {{'defer_build': False}}",
                    f'CREATE PRIMARY INDEX `#primary_Q65JY7lol` ON default:{self.test_bucket}.test_scope_1.test_collection_1 USING GSI',
                    f"CREATE INDEX `hotel88983c146f0e4c55a9734e20cb7d3b44free_breakfast_avg_rating` ON default:{self.test_bucket}.test_scope_1.test_collection_1(free_breakfast,avg_rating) USING GSI  WITH {{'defer_build': False}}",
                    f"CREATE INDEX `hotel88983c146f0e4c55a9734e20cb7d3b44free_breakfast_array_count` ON default:{self.test_bucket}.test_scope_1.test_collection_1(free_breakfast,type,free_parking,array_count(public_likes),price,country) USING GSI  WITH {{'defer_build': False}}",
                    f"CREATE INDEX `hotel88983c146f0e4c55a9734e20cb7d3b44flatten_keys` ON default:{self.test_bucket}.test_scope_1.test_collection_1(DISTINCT ARRAY FLATTEN_KEYS(r.author,r.ratings.Cleanliness) FOR r IN reviews when r.ratings.Cleanliness < 4 END,country,email,free_parking) USING GSI  WITH {{'defer_build': False}}",
                    f"CREATE INDEX `hotel88983c146f0e4c55a9734e20cb7d3b44missing_keys` ON default:{self.test_bucket}.test_scope_1.test_collection_1(city INCLUDE MISSING DESC,avg_rating,country) USING GSI  WITH {{'defer_build': False}}",
                    f"CREATE INDEX `hotel88983c146f0e4c55a9734e20cb7d3b44array_index_overall` ON default:{self.test_bucket}.test_scope_1.test_collection_1(price, All ARRAY v.ratings.Overall FOR v IN reviews END) USING GSI  WITH {{'defer_build': False}}",
                    f"CREATE INDEX `hotel88983c146f0e4c55a9734e20cb7d3b44array_index_rooms` ON default:{self.test_bucket}.test_scope_1.test_collection_1(price, All ARRAY v.ratings.Rooms FOR v IN reviews END) USING GSI  WITH {{'defer_build': False}}",
                    f"CREATE INDEX `hotel88983c146f0e4c55a9734e20cb7d3b44array_index_checkin` ON default:{self.test_bucket}.test_scope_1.test_collection_1(country,DISTINCT ARRAY `r`.`ratings`.`Check in / front desk` FOR r in `reviews` END,array_count(`public_likes`),array_count(`reviews`) DESC,`type`,phone,price,email,address,name,url) USING GSI  WITH {{'defer_build': False}}"]
                l2 = [
                    f"CREATE INDEX `hotel88983c146f0e4c55a9734e20cb7d3b44price` ON default:{self.test_bucket}._default._default(price) USING GSI  WITH {{'defer_build': False}}",
                    f'CREATE PRIMARY INDEX `#primary_Q65JY7lol` ON default:{self.test_bucket}._default._default USING GSI',
                    f"CREATE INDEX `hotel88983c146f0e4c55a9734e20cb7d3b44free_breakfast_avg_rating` ON default:{self.test_bucket}._default._default(free_breakfast,avg_rating) USING GSI  WITH {{'defer_build': False}}",
                    f"CREATE INDEX `hotel88983c146f0e4c55a9734e20cb7d3b44free_breakfast_array_count` ON default:{self.test_bucket}._default._default(free_breakfast,type,free_parking,array_count(public_likes),price,country) USING GSI  WITH {{'defer_build': False}}",
                    f"CREATE INDEX `hotel88983c146f0e4c55a9734e20cb7d3b44flatten_keys` ON default:{self.test_bucket}._default._default(DISTINCT ARRAY FLATTEN_KEYS(r.author,r.ratings.Cleanliness) FOR r IN reviews when r.ratings.Cleanliness < 4 END,country,email,free_parking) USING GSI  WITH {{'defer_build': False}}",
                    f"CREATE INDEX `hotel88983c146f0e4c55a9734e20cb7d3b44missing_keys` ON default:{self.test_bucket}._default._default(city INCLUDE MISSING DESC,avg_rating,country) USING GSI  WITH {{'defer_build': False}}",
                    f"CREATE INDEX `hotel88983c146f0e4c55a9734e20cb7d3b44array_index_overall` ON default:{self.test_bucket}._default._default(price, All ARRAY v.ratings.Overall FOR v IN reviews END) USING GSI  WITH {{'defer_build': False}}",
                    f"CREATE INDEX `hotel88983c146f0e4c55a9734e20cb7d3b44array_index_rooms` ON default:{self.test_bucket}._default._default(price, All ARRAY v.ratings.Rooms FOR v IN reviews END) USING GSI  WITH {{'defer_build': False}}",
                    f"CREATE INDEX `hotel88983c146f0e4c55a9734e20cb7d3b44array_index_checkin` ON default:{self.test_bucket}._default._default(country,DISTINCT ARRAY `r`.`ratings`.`Check in / front desk` FOR r in `reviews` END,array_count(`public_likes`),array_count(`reviews`) DESC,`type`,phone,price,email,address,name,url) USING GSI  WITH {{'defer_build': False}}"]
                for query_list in [l1, l2]:
                    self.gsi_util_obj.create_gsi_indexes(create_queries=query_list, query_node=self.query_node)
                self.wait_until_indexes_online()
                select_queries = [f'SELECT name FROM default:{self.test_bucket}._default._default WHERE name like "%Dil%"', f'SELECT name FROM default:{self.test_bucket}.test_scope_1.test_collection_1 WHERE avg_rating > 3 AND free_breakfast = true', f'SELECT name FROM default:{self.test_bucket}.test_scope_1.test_collection_1 WHERE avg_rating > 3 AND country like "%F%"', f'SELECT suffix FROM default:{self.test_bucket}.test_scope_1.test_collection_1 WHERE suffix is not NULL', f'SELECT name FROM default:{self.test_bucket}.test_scope_1.test_collection_1 WHERE name like "%Dil%"', f'SELECT price FROM default:{self.test_bucket}.test_scope_1.test_collection_1 WHERE price > 0', f"SELECT name FROM default:{self.test_bucket}.test_scope_1.test_collection_1 WHERE ANY r IN reviews SATISFIES r.author LIKE 'M%' AND r.ratings.Cleanliness = 3 END AND free_parking = TRUE AND country IS NOT NULL ", f'SELECT name FROM default:{self.test_bucket}._default._default WHERE ANY v IN reviews SATISFIES v.ratings.`Rooms` > 3  END and price > 1000 ', f"SELECT name FROM default:{self.test_bucket}._default._default WHERE ANY r IN reviews SATISFIES r.author LIKE 'M%' AND r.ratings.Cleanliness = 3 END AND free_parking = TRUE AND country IS NOT NULL ", f'SELECT price FROM default:{self.test_bucket}._default._default WHERE price > 0', f"SELECT country, avg(price) as AvgPrice, min(price) as MinPrice, max(price) as MaxPrice FROM default:{self.test_bucket}._default._default WHERE free_breakfast=True and free_parking=True and price is not null and array_count(public_likes)>5 and `type`='Hotel' group by country", f'SELECT suffix FROM default:{self.test_bucket}._default._default WHERE suffix is not NULL', f'SELECT name FROM default:{self.test_bucket}._default._default WHERE avg_rating > 3 AND country like "%F%"', f"SELECT country, avg(price) as AvgPrice, min(price) as MinPrice, max(price) as MaxPrice FROM default:{self.test_bucket}.test_scope_1.test_collection_1 WHERE free_breakfast=True and free_parking=True and price is not null and array_count(public_likes)>5 and `type`='Hotel' group by country", f'SELECT address FROM default:{self.test_bucket}._default._default WHERE country is not null and `type` is not null and (any r in reviews satisfies r.ratings.`Check in / front desk` is not null end) ', f'SELECT address FROM default:{self.test_bucket}._default._default WHERE ANY v IN reviews SATISFIES v.ratings.`Overall` > 3  END and price < 1000 ', f'SELECT name FROM default:{self.test_bucket}.test_scope_1.test_collection_1 WHERE ANY v IN reviews SATISFIES v.ratings.`Rooms` > 3  END and price > 1000 ', f'SELECT address FROM default:{self.test_bucket}.test_scope_1.test_collection_1 WHERE ANY v IN reviews SATISFIES v.ratings.`Overall` > 3  END and price < 1000 ', f'SELECT address FROM default:{self.test_bucket}.test_scope_1.test_collection_1 WHERE country is not null and `type` is not null and (any r in reviews satisfies r.ratings.`Check in / front desk` is not null end) ', f'SELECT name FROM default:{self.test_bucket}._default._default WHERE avg_rating > 3 AND free_breakfast = true']
                index_names_before_upgrade = self.get_all_indexes_in_the_cluster()
