...
class SAMLTest(BaseTestCase):
    ...
    def test_sso_login(self):
        ...
        # STEP 3: Initiate single sign on
        self.log.info('STEP 1: Initiate single sign on')
        ...
        # Step 4: Redirect to the IdP
        self.log.info('Step 2: Redirect to the IdP')
        ...
        # Step 5: SSO user authentication via the IdP
        self.log.info('Step 3: SSO user authentication via the IdP')
        ...
        # Step 6: Get the SAML response from the IdP
        self.log.info('Step 4: Get the SAML response from the IdP')
        ...
        # Step 7: Send the SAML response to Couchbase and set a session for the SSO user
        self.log.info('Step 5: Send the SAML response to Couchbase and set a session for teh SSO '
                      'user')
        ...
        # Step 8: Use the session and verify SSO login
        self.log.info('Step 6: Use the session and verify SSO login')
