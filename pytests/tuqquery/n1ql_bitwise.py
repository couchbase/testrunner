...
class QueryBitwiseTests(QueryTests):
    ...
    def test_bitwise_and_zeros_and_ones(self):
        ...
        self.assertEqual(actual_result['results'],[{u'$1': 0}])
    ...
    def test_bitwise_and_long_integers(self):
        ...
        actual_result = self.run_cbq_query()
        self.assertEqual(actual_result['results'],[{u'$1': None}])

    def test_bitwise_and_numeric_values(self):
        self.query = "select bitand(11,3)"
        actual_result = self.run_cbq_query()
        self.assertEqual(actual_result['results'],[{u'$1': 3}])
    ...
    def test_bitwise_not(self):
        ...
        actual_result = self.run_cbq_query()
        self.assertEquals(actual_result['results'],[{u'$1': -4}])
    ...
    def test_bitwise_xor(self):
        ...
        actual_result = self.run_cbq_query()
        self.assertEquals(actual_result['results'],[{u'$1': 5}])

    def test_bitshift(self):
        self.query = "Select BitSHIFT(6,1,false)"
        actual_result = self.run_cbq_query()
        self.assertEquals(actual_result['results'],[{u'$1': 12}])
        self.query = "Select BitSHIFT(8,-2)"
        actual_result = self.run_cbq_query()
        self.assertEquals(actual_result['results'],[{u'$1': 2}])
        self.query = "Select BitSHIFT(123,2,true)"
        actual_result = self.run_cbq_query()
        self.assertEquals(actual_result['results'],[{u'$1': 492}])
        self.query = "select bitshift(123,2)"
        actual_result = self.run_cbq_query()
        self.assertEquals(actual_result['results'],[{u'$1': 492}])
        self.query = "Select BitSHIFT(234,-2,true)"
        actual_result = self.run_cbq_query()
        self.assertEquals(actual_result['results'],[{u'$1': -9223372036854775750}])
        self.query = "select bitshift(323,-2)"
        actual_result = self.run_cbq_query()
        self.assertEquals(actual_result['results'],[{u'$1': 80}])
        self.query = "Select bitshift(BitSHIFT(432424234434,-2,true),2,true)"
        actual_result = self.run_cbq_query()
        self.assertEquals(actual_result['results'],[{u'$1': 432424234434}])
        self.query = "Select bitshift(BitSHIFT(432424234434,2,true),-2,true)"
        actual_result = self.run_cbq_query()
        self.assertEquals(actual_result['results'],[{u'$1': 432424234434}])
    ...
    def test_default_bitand_bitor_bitxor_bitnot(self):
        ...
        actual_result = self.run_cbq_query()
        self.assertEqual(actual_result['results'],[{u'$1': 10}])
    ...
    def test_bitset(self):
        ...
        actual_result = self.run_cbq_query()
        self.assertEqual(actual_result['results'],[{u'$1': 7}])
        self.query = "Select BitSET(6,[1,2])"
        actual_result = self.run_cbq_query()
        self.assertEqual(actual_result['results'],[{u'$1': 7}])
        self.query = "select bitset(6,[])"
        actual_result = self.run_cbq_query()
        self.assertEqual(actual_result['results'],[{u'$1': 6}])
        ...
        actual_result = self.run_cbq_query()
        self.assertEqual(actual_result['results'],[{u'$1': 15}])
    ...
    def test_is_bitset(self):
        ...
        actual_result = self.run_cbq_query()
        self.assertEqual(actual_result['results'],[{u'$1': False}])
        self.query = "Select IsBitSET(6,2,true)"
        actual_result = self.run_cbq_query()
        self.assertEqual(actual_result['results'],[{u'$1': True}])
    ...
    def test_bitclear(self):
        ...
        actual_result = self.run_cbq_query()
        self.assertEqual(actual_result['results'],[{u'$1': 4}])
