...
class QuerySecurityTests(ServerlessBaseTestCase):
    ...
    def test_system_catalog(self):
        ...
        all_keyspaces_1 = [
            ...
            {'path': f'default:{database1.id}._system._regulator'}, 
        ...
        all_keyspaces_2 = [
            ...
            {'path': f'default:{database2.id}._system._regulator'}, 
...
# MB-56451            'prepareds':  {'statement': 'SELECT DISTINCT name FROM system:prepareds WHERE name like "p%"', 'expected1': [{'name': f'p1(default:{database1.id})'}, {'name': 'p1'}], 'expected2': [{'name': f'p2(default:{database2.id})'}, {'name': 'p2'}]},
