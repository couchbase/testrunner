...
class QueryTests(BaseTestCase):
    ...
    def suite_setUp(self):
        version = self.input.param("cbq_version", "dev_preview1")
        self._start_command_line_query(version, self.master)
    ...
    def _start_command_line_query(self, version, server):
        cbq_url = self.build_url(version)
        #TODO for windows
