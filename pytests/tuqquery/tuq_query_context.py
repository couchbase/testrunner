...
class QueryContextTests(QueryTests):
    ...
    def test_invalid_context(self):
        ...
        try:
            ...
            self.assertTrue('Keyspace not found in CB datastore: fakevalue:test1 - cause: No bucket named test1' in str(e) or 'Invalid path specified: default:fakevalue.test1 has invalid number of parts' in str(e))
