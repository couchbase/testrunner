...
class N1qlFTSSanityTest(QueryTests):
    ...
    def test_n1ql_syntax_select_from_let(self):
        ...
        self._create_fts_index(index_name="idx_default_fts", doc_count=98784, source_name=query_bucket)
        self.drop_index_safe(bucket_name=self.default_bucket_name, index_name="#primary", is_primary=True)
