function OnUpdate(doc, meta) {
    try {
        ...
        log("Running Numeric Range Query");
        var numericRangeQuery = couchbase.SearchQuery.numericRange()
            .field("reviews.ratings.Cleanliness")
            .min(4, true);
        writeQueryResult("numericRangeQuery", runQuery(numericRangeQuery, { size: 731 }), meta);
    } catch (e) {
