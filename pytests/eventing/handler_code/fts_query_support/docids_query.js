function OnUpdate(doc, meta) {
    try {
        ...
        log("Running Doc IDs Query");
        var docIdsQuery = couchbase.SearchQuery.docIds("airport_8850", "airport_8851");
        writeQueryResult("docIdsQuery", runQuery(docIdsQuery, {size: 2}), meta);
    } catch (e) {
