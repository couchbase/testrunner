...
class EventingUpgrade(NewUpgradeBaseTest, EventingBaseTest):
    ...
    def test_offline_upgrade_with_eventing(self):
        ...
        # Post-upgrade features: collections, new handlers
    ...
    def _create_upgrade_buckets(self):
        ...
        self.bucket_storage = 'couchstore'
    ...
    def _deploy_post_upgrade_handlers(self):
        """Deploy post-upgrade (collection-scoped) handlers."""
        self.add_built_in_server_user()
        self.restServer = self.get_nodes_from_services_map(service_type="eventing")
        self.rest = RestConnection(self.restServer)
        # Core handlers: sbm, curl, n1ql
        ...
        self.create_function_with_collection(
            ...
            src_namespace="src_bucket.event.coll_0")
        post_upgrade_handlers = ["sbm", "curl", "n1ql"]
        # Deploy all handlers
    ...
    def _run_full_mutation_cycle(self):
    ...
    def _run_pause_resume_cycle(self):
