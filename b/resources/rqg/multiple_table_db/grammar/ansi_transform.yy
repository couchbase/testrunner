...
select:
	SELECT select_from FROM BUCKET_NAME joins WHERE complex_condition ORDER BY field_list nulls_first_last |
...
joins:
	LEFT JOIN BUCKET_NAME ON ( ansi_joins_complex_condition ) INNER JOIN BUCKET_NAME ON (ansi_joins_complex_condition) | LEFT JOIN BUCKET_NAME ON (ansi_joins_complex_condition) ;
