...
class ActiveRepositoryApi(object):
    ...
    def cluster_active_repository_active_id_archive_post(self, id, **kwargs):  # noqa: E501
        """Archives the repository  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.cluster_active_repository_active_id_archive_post(id, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.cluster_active_repository_active_id_archive_post_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.cluster_active_repository_active_id_archive_post_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def cluster_active_repository_active_id_archive_post_with_http_info(self, id, **kwargs):  # noqa: E501
        """Archives the repository  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.cluster_active_repository_active_id_archive_post_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method cluster_active_repository_active_id_archive_post" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `cluster_active_repository_active_id_archive_post`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/cluster/active/repository/active/{id}/archive', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def cluster_active_repository_active_id_pause_post(self, id, **kwargs):  # noqa: E501
        """Pauses the active repository  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.cluster_active_repository_active_id_pause_post(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.cluster_active_repository_active_id_pause_post_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.cluster_active_repository_active_id_pause_post_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def cluster_active_repository_active_id_pause_post_with_http_info(self, id, **kwargs):  # noqa: E501
        """Pauses the active repository  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.cluster_active_repository_active_id_pause_post_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method cluster_active_repository_active_id_pause_post" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `cluster_active_repository_active_id_pause_post`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/cluster/active/repository/active/{id}/pause', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def cluster_active_repository_active_id_post(self, id, **kwargs):  # noqa: E501
        """Creates an active repository  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.cluster_active_repository_active_id_post(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.cluster_active_repository_active_id_post_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.cluster_active_repository_active_id_post_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def cluster_active_repository_active_id_post_with_http_info(self, id, **kwargs):  # noqa: E501
        """Creates an active repository  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.cluster_active_repository_active_id_post_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method cluster_active_repository_active_id_post" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `cluster_active_repository_active_id_post`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/cluster/active/repository/active/{id}', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def cluster_active_repository_active_id_resume_post(self, id, **kwargs):  # noqa: E501
        """Resumes the paused repository  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.cluster_active_repository_active_id_resume_post(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.cluster_active_repository_active_id_resume_post_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.cluster_active_repository_active_id_resume_post_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def cluster_active_repository_active_id_resume_post_with_http_info(self, id, **kwargs):  # noqa: E501
        """Resumes the paused repository  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.cluster_active_repository_active_id_resume_post_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method cluster_active_repository_active_id_resume_post" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `cluster_active_repository_active_id_resume_post`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/cluster/active/repository/active/{id}/resume', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
