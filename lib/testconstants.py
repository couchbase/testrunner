...
COUCHBASE_FROM_4DOT6 = ["4.6.0", "4.6.1", "4.6.2", "4.6.3", "4.6.4", "4.6.5", "4.7.0",
                        ...
                        "6.0.0", "6.0.1", "6.0.2", "6.0.3", "6.0.4", "6.5.0", "7.0.0"]
...
COUCHBASE_FROM_VULCAN = ["0.0.0", "5.5.0", "5.5.1", "5.5.2", "5.5.3", "5.5.4", "5.5.5",
			 ...
			 "7.0.0"]
COUCHBASE_FROM_ALICE = ["0.0.0", "6.0.0", "6.0.1", "6.0.2", "6.0.3", "6.0.4", "6.5.0", "7.0.0"]
COUCHBASE_FROM_601 = ["0.0.0", "6.0.1", "6.0.2", "6.0.3", "6.0.4", "6.5.0", "7.0.0"]
COUCHBASE_FROM_MAD_HATTER = ["0.0.0", "6.5.0", "7.0.0"]
