...
COUCHBASE_FROM_MAD_HATTER = ["0.0.0", "6.5.0", "6.5.1", "6.5.2", "6.6.0", "6.6.1", "6.6.2", "6.6.3",
                             "6.6.4", "6.6.5", "7.0.0", "7.0.1", "7.0.2", "7.0.3", "7.0.4", "7.1.0", "7.1.1"]
# Update release build here for upgrade tests
COUCHBASE_FROM_CHESHIRE_CAT = ["0.0.0", "7.0.0", "7.0.1", "7.0.2", "7.0.3", "7.0.4", "7.1.0", "7.1.1"]
COUCHBASE_FROM_NEO = ["0.0.0", "7.1.0", "7.1.1"]
