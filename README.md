...
prefixed by "KEY_". max_creates limits the no. of items created.
...
Set up the moxi on the client side as follows:
(Make sure couchbase-server is installed on the client)
	...
	cycle=200 http://xx.xx.xx.xxx:8091/pools/default/bucketsStreaming/default -d```
