  		...
  		"0" :
                {
                    ...
                    "workload" : [{"spec" : "s:100,ops:1000"},
                                  {"spec" : "b:saslbucket,pwd:password,s:100,ops:1000"}],
                    "runtime" : 40 },
		    ...
		    "runtime" : 180 },
                ...
                "3" :
                {
                    ...
                    "workload" :[{"spec": "g:100,coq:defaultph2keys,ops:12000"},
                                 {"spec": "b:saslbucket,pwd:password,g:100,coq:saslph2keys,ops:12000"}],
                    "runtime": 1800
                },
               ...
               "6" :
                ...
                "10" :
                {
                    ...
                    "workload" : [{"spec" : "g:100,coq:defaultph2keys,ops:10",
                                  ...
                                  "conditions" : "post:ep_queue_size < 1000000"}]
